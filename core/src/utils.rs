...
pub fn render_docs(method_info: &HashMap<String, MethodInfo>) -> serde_json::Value {
    ...
    for (method_name, info) in method_info {
        ...
        // Basic method info
        method_doc.insert("summary".to_string(), 
            serde_json::Value::String(
                info.description.clone().unwrap_or_else(|| format!("Execute {} method", method_name))
            )
        );
        ...
        properties.insert("jsonrpc".to_string(), serde_json::json!({
            "type": "string",
            "enum": ["2.0"],
            "description": "JSON-RPC version"
        }));
        properties.insert("method".to_string(), serde_json::json!({
            "type": "string",
            "enum": [method_name],
        ...
        schema.insert("required".to_string(), serde_json::json!(["jsonrpc", "method"]));
        ...
        method_doc.insert("requestBody".to_string(), serde_json::Value::Object(request_body));
        
        // Response schema
        let mut responses = serde_json::Map::new();
        let mut success_response = serde_json::Map::new();
        success_response.insert("description".to_string(), 
        ...
        success_schema.insert("type".to_string(), serde_json::Value::String("object".to_string()));
        
        let mut success_properties = serde_json::Map::new();
        success_properties.insert("jsonrpc".to_string(), serde_json::json!({
            "type": "string",
            "enum": ["2.0"]
        }));
        success_properties.insert("id".to_string(), serde_json::json!({
            "oneOf": [
                {"type": "string"},
                {"type": "number"},
                {"type": "null"}
        ...
        if let Some(result_schema) = &info.result_schema {
            ...
            success_properties.insert("result".to_string(), serde_json::json!({
                "description": "Method result"
            }));
        }
        
        success_schema.insert("properties".to_string(), serde_json::Value::Object(success_properties));
        success_schema.insert("required".to_string(), serde_json::json!(["jsonrpc", "result"]));
        
        success_json.insert("schema".to_string(), serde_json::Value::Object(success_schema));
        success_content.insert("application/json".to_string(), serde_json::Value::Object(success_json));
        success_response.insert("content".to_string(), serde_json::Value::Object(success_content));
        
        responses.insert("200".to_string(), serde_json::Value::Object(success_response));
        ...
        method_doc.insert("responses".to_string(), serde_json::Value::Object(responses));
