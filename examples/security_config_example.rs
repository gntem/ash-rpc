...
fn main() {
    ...
    println!("   Max connections: {} (default)", default_security.max_connections);
    println!("   Max request size: {} bytes (default)", default_security.max_request_size);
    println!("   Request timeout: {:?} (default)", default_security.request_timeout);
    println!("   Idle timeout: {:?} (default)\n", default_security.idle_timeout);
    ...
    println!("   Max request size: {:?} bytes", capabilities.max_request_size);
    println!("   Request timeout: {:?} seconds\n", capabilities.request_timeout_secs);
