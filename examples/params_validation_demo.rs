...
rpc_method!(AddNumbersMethod, "add_numbers", |params: Option<serde_json::Value>, id| {
...
rpc_method!(GreetMethod, "greet", |params: Option<serde_json::Value>, id| {
...
rpc_method!(SafeDivideMethod, "safe_divide", |params: Option<serde_json::Value>, id| {
...
async fn main() {
    ...
    let request = RequestBuilder::new("add_numbers")
        ...
        .build();
    let response = registry.call("add_numbers", request.params, request.id).await;
    println!("Add numbers response: {}", serde_json::to_string_pretty(&response).unwrap());
    ...
    println!("Greet with name: {}", serde_json::to_string_pretty(&response).unwrap());
    ...
    let request = RequestBuilder::new("greet")
        ...
        .build();
    let response = registry.call("greet", request.params, request.id).await;
    println!("Greet without name: {}", serde_json::to_string_pretty(&response).unwrap());
    ...
    let request = RequestBuilder::new("safe_divide")
        ...
        .build();
    let response = registry.call("safe_divide", request.params, request.id).await;
    println!("Safe divide response: {}", serde_json::to_string_pretty(&response).unwrap());
    ...
    let request = RequestBuilder::new("safe_divide")
        ...
        .build();
    let response = registry.call("safe_divide", request.params, request.id).await;
    println!("Safe divide by zero: {}", serde_json::to_string_pretty(&response).unwrap());
}